export class CcsEntitlementModel{
   /* public id: string;
    ...
    absencesAvailableNoEvidence: number;
    ...
    constructor(message?: any) {
        ...
        this.paidAbsences = message.paid_absence;
        this.unpaidAbsences = message.unpaid_absence;
        this.absencesAvailableNoEvidence = message.absences_available_no_evidence;
    }
