...
@Component({
    ...
    styleUrls: ['./account-balance-report.component.scss'],
...
export class AccountBalanceReportComponent implements OnInit, OnDestroy {
    ...
    submitReport(event: MouseEvent, view: boolean, isPdf: boolean): void {
        ...
        this._financeReportService
            .getAccountBalanceReportData(sendObj, this.reportType, view, isPdf)
            .pipe(
