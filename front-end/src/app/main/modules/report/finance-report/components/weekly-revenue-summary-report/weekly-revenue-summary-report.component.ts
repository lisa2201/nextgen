...
@Component({
    selector: 'app-weekly-revenue-summary-report',
    templateUrl: './weekly-revenue-summary-report.component.html',
    styleUrls: ['./weekly-revenue-summary-report.component.scss'],
...
export class WeeklyRevenueSummaryReportComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        this.reportData = [];
        this.infoMessage = `Revenue is based on parent payment plan. CCS includes actual ccs payment and the estimates.`;
    ...
    submitReport(event: MouseEvent, view: boolean, isPdf: boolean): void {
        ...
        this._financeReportService
            .getWeeklyRevenueSummaryReportData(sendObj,this.reportType, view, isPdf)
            .pipe(
