...
export class CcsEntitlementHistoryService implements Resolve<any> {
    ...
    private messagelist: CcsEntitlementModel[];
    ...
    onEnrolmentIDChanged: Subject<any>;
    filterBy: any = '0';
    // flterByRange: any;
    filterByRange = {
        sDate: '',
    ...
    constructor(
        ...
        this.onEnrolmentIDChanged  = new Subject();
        this.reportData = [
            {
                index: 0,
                name: 'Enrolment ID',
    ...
    getMessageData(enrolID: string): Promise<any> {
        ...
        const params = new HttpParams()
            ...
            .set('enrolmentID', enrolID)
            .set('filters', (this.filterBy) ? JSON.stringify(this.filterBy) : null);
    ...
    setEvents(): void{
        ...
        this.onPaginationChanged
            ...
            .subscribe(pagination => {
                ...
                this.getMessageData(this.enrolmentID);
            });
