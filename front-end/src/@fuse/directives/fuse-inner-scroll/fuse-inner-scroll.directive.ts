...
export class FuseInnerScrollDirective implements OnInit, OnDestroy
{
    ...
    private _skipMediaChange: boolean;
    ...
    /**
     * handel scroll on page criteria
     * @param remove 
     */
    handelScrollOnDemand(remove: boolean): void
    {
        remove ? this._removeClass() : this._addClass();

        this._skipMediaChange = remove;
    }
}
