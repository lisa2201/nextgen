...
export class EnrollmentFormResolverService implements Resolve<Observable<any>> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any> | Promise<any> | any {
        ...
        if (this._authService._domain === AppConst.appStart.ENROLLMENT.NAME) {
            ...
            // if (client && client.id) {
            //     // Get form fields
            //     return this._sectionService.enrolmentDynamicFields(client.id,AppConst.appStart.ENROLLMENT.NAME)
            // } else {
            ...
            return new Promise((resolve, reject) => {
                this._authService.getClientInformation().pipe(
                    ...
                    shareReplay()
                        ...
                        this._sectionService.enrolmentDynamicFields(value['data'].id, AppConst.appStart.ENROLLMENT.NAME).subscribe(formSettings => resolve({
