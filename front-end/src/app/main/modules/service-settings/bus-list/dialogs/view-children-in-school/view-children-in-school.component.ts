...
@Component({
    selector: 'buslist-view-children-in-school',
    templateUrl: './view-children-in-school.component.html',
    styleUrls: ['./view-children-in-school.component.scss'],
...
export class ViewChildrenInSchoolComponent implements OnInit, OnDestroy
{
     ...
     */
    constructor(
        public matDialogRef: MatDialogRef<ViewChildrenInSchoolComponent>,
        ...
        this.busList = _data.response.school.bus;
        this.school = _data.response.school;
...
ngOnInit(): void {
    ...
    /*addChildren(e: MouseEvent): void
    {
       ...
       const sendObj = {
           ...
           return_school_children: true
       }

        this._busListService.addChildrenToBus(sendObj, null, this.school.id)
