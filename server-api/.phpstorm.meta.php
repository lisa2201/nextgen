    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Illuminate\Contracts\Console\Kernel' => \Kinderm8\Console\Kernel::class,
            'Illuminate\Contracts\Debug\ExceptionHandler' => \NunoMaduro\Collision\Adapters\Laravel\ExceptionHandler::class,
            'Illuminate\Contracts\Http\Kernel' => \Kinderm8\Http\Kernel::class,
            ...
            'Kinderm8\Repositories\AllergyTypes\IAllergyTypesRepository' => \Kinderm8\Repositories\AllergyTypes\AllergyTypesRepository::class,
            'Kinderm8\Repositories\Attendance\IAttendanceRepository' => \Kinderm8\Repositories\Attendance\AttendanceRepository::class,
            'Kinderm8\Repositories\BookingRequest\IBookingRequestRepository' => \Kinderm8\Repositories\BookingRequest\BookingRequestRepository::class,
            'Kinderm8\Repositories\Booking\IBookingRepository' => \Kinderm8\Repositories\Booking\BookingRepository::class,
            'Kinderm8\Repositories\Branch\IBranchRepository' => \Kinderm8\Repositories\Branch\BranchRepository::class,
            'Kinderm8\Repositories\Bus\IBusListRepository' => \Kinderm8\Repositories\Bus\BusListRepository::class,
            'Kinderm8\Repositories\CCSEnrolment\ICCSEnrolmentRepository' => \Kinderm8\Repositories\CCSEnrolment\CCSEnrolmentRepository::class,
            'Kinderm8\Repositories\CCSEntitlement\ICCSEntitlementRepository' => \Kinderm8\Repositories\CCSEntitlement\CCSEntitlementRepository::class,
            'Kinderm8\Repositories\CCSSetup\ICCSSetupRepository' => \Kinderm8\Repositories\CCSSetup\CCSSetupRepository::class,
            'Kinderm8\Repositories\Category\ICategoryRepository' => \Kinderm8\Repositories\Category\CategoryRepository::class,
            'Kinderm8\Repositories\Child\IChildRepository' => \Kinderm8\Repositories\Child\ChildRepository::class,
            'Kinderm8\Repositories\Contactreport\IContactReportRepository' => \Kinderm8\Repositories\Contactreport\ContactReportRepository::class,
            'Kinderm8\Repositories\EducatorRatio\IEducatorRatioRepository' => \Kinderm8\Repositories\EducatorRatio\EducatorRatioRepository::class,
            'Kinderm8\Repositories\EmergencyContact\IEmergencyContactRepository' => \Kinderm8\Repositories\EmergencyContact\EmergencyContactRepository::class,
            'Kinderm8\Repositories\Fee\IFeeRepository' => \Kinderm8\Repositories\Fee\FeeRepository::class,
            'Kinderm8\Repositories\FinanceReport\IFinanceReportRepository' => \Kinderm8\Repositories\FinanceReport\FinanceReportRepository::class,
            'Kinderm8\Repositories\Immunisation\IImmunisationRepository' => \Kinderm8\Repositories\Immunisation\ImmunisationRepository::class,
            'Kinderm8\Repositories\Invitation\IInvitationRepository' => \Kinderm8\Repositories\Invitation\InvitationRepository::class,
            'Kinderm8\Repositories\Organization\IOrganizationRepository' => \Kinderm8\Repositories\Organization\OrganizationRepository::class,
            'Kinderm8\Repositories\ParentFinanceExclusion\IParentFinanceExclusionRepository' => \Kinderm8\Repositories\ParentFinanceExclusion\ParentFinanceExclusionRepository::class,
            'Kinderm8\Repositories\ParentPaymentProvider\IParentPaymentProviderRepository' => \Kinderm8\Repositories\ParentPaymentProvider\ParentPaymentProviderRepository::class,
            'Kinderm8\Repositories\ParentPaymentSchedule\IParentPaymentScheduleRepository' => \Kinderm8\Repositories\ParentPaymentSchedule\ParentPaymentScheduleRepository::class,
            'Kinderm8\Repositories\PaymentTerms\IPaymentTermsRepository' => \Kinderm8\Repositories\PaymentTerms\PaymentTermsRepository::class,
            'Kinderm8\Repositories\Permission\IPermissionRepository' => \Kinderm8\Repositories\Permission\PermissionRepository::class,
            'Kinderm8\Repositories\Provider\IProviderRepository' => \Kinderm8\Repositories\Provider\ProviderRepository::class,
            'Kinderm8\Repositories\Receipt\IReceiptRepository' => \Kinderm8\Repositories\Receipt\ReceiptRepository::class,
            'Kinderm8\Repositories\Reimbursements\IReimbursementsRepository' => \Kinderm8\Repositories\Reimbursements\ReimbursementsRepository::class,
            'Kinderm8\Repositories\ReportFieldSave\IReportFieldSaveRepository' => \Kinderm8\Repositories\ReportFieldSave\ReportFieldSaveRepository::class,
            'Kinderm8\Repositories\Role\IRoleRepository' => \Kinderm8\Repositories\Role\RoleRepository::class,
            'Kinderm8\Repositories\Room\IRoomRepository' => \Kinderm8\Repositories\Room\RoomRepository::class,
            'Kinderm8\Repositories\School\ISchoolRepository' => \Kinderm8\Repositories\School\SchoolRepository::class,
            'Kinderm8\Repositories\Service\IServiceRepository' => \Kinderm8\Repositories\Service\ServiceRepository::class,
            'Kinderm8\Repositories\SessionSubmission\ISessionSubmissionRepository' => \Kinderm8\Repositories\SessionSubmission\SessionSubmissionRepository::class,
            'Kinderm8\Repositories\StaffAttendance\IStaffAttendanceRepository' => \Kinderm8\Repositories\StaffAttendance\StaffAttendanceRepository::class,
            'Kinderm8\Repositories\Supplier\ISupplierRepository' => \Kinderm8\Repositories\Supplier\SupplierRepository::class,
            'Kinderm8\Repositories\User\IUserRepository' => \Kinderm8\Repositories\User\UserRepository::class,
            'Kinderm8\Services\AWS\SNSContract' => \Kinderm8\Services\AWS\SNSService::class,
            'Kinderm8\Services\DatabaseBatch\BatchContract' => \Kinderm8\Services\DatabaseBatch\BatchService::class,
