...
@Component({
    selector: 'query-payments-list-view',
    templateUrl: './query-payments-list-view.component.html',
    styleUrls: ['./query-payments-list-view.component.scss'],
...
export class QueryPaymentsListViewComponent implements OnInit, OnDestroy {
    dialogRef: any;
    ...
    goToDetail(event: MouseEvent, item: any): void {
        this.dialogRef = this._matDialog
            .open(QueryPaymentsDetailComponent,
                {
                    panelClass: 'query-payments-detail',
