import { Component, OnInit, ViewEncapsulation, OnDestroy, ViewChild, Inject, ElementRef } from '@angular/core';
...
@Component({
    selector: 'manage-master-roll-bookings',
    templateUrl: './manage-master-roll-bookings.component.html',
    styleUrls: ['./manage-master-roll-bookings.component.scss'],
...
export class ManageMasterRollBookingsComponent implements OnInit, OnDestroy {
     ...
     * Constructor
     * 
     * @param {MatDialogRef<ManageMasterRollBookingsComponent>} matDialogRef
     ...
     */
    constructor(
        public matDialogRef: MatDialogRef<ManageMasterRollBookingsComponent>,
    ...
    ngOnInit(): void
    {
        this._logger.debug('manage master roll booking !!!', this._data);
    ...
    previewSlots(e: MouseEvent): void
    {
        ...
        this._masterRollService
            .getManagerPreviewSlots(sendObj)
            .pipe(
            ...
            .confirm(
                {
                    ...
                    nzOnOk: () =>
                    {
                        ...
                        { 
                            ...
                            this._logger.debug('[manage master roll bookings - update/delete]', sendObj);
    
                            this.manageButtonLoader = true;
    
                            this._masterRollService
                                .manageBookings(sendObj)
                                .pipe(
                                    takeUntil(this._unsubscribeAll),
                                    finalize(() =>
                                    {
