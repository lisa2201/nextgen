...
class CreateWaitlistQuestionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('km8_waitlist_questions', function (Blueprint $table) {
...
//                ->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('km8_waitlist_questions');
    }
}
